...
firstTwoDigitsRE :: RE Char String
firstTwoDigitsRE = (<>) <$> (list <$> psym isZero) <*> (list <$> psym isTel)

twoDigitsRE :: RE Char String
twoDigitsRE = (<>) <$> digitRE <*> digitRE

telephoneRE :: RE Char Telephone
telephoneRE = Telephone <$> firstTwoDigitsRE
              <*> (ssym '.' *> twoDigitsRE)
              <*> (ssym '.' *> twoDigitsRE)
              <*> (ssym '.' *> twoDigitsRE)
              <*> (ssym '.' *> twoDigitsRE)
...
-- >>> validateTel "06.02.03.04.05"
-- Validation (Right 06.02.03.04.05)

-- >>> validateTel "00.02.03.04.05"
-- Validation (Left ["Numero de telephone mal-forme: 00.02.03.04.05"])
