...
-- [[3,9,9,2,7,6,9,8,4,4],[1,4,10,5,7],[10,4,9]]
```
...
On aurait ici, *grosso modo*, 60% de chance de tirer un nombre entre 1 et 10, 30% entre 100 et 110 et 10% entre 1000 et 1010.
...
genPair2 genFst genSnd = (,) <$> genFst <*> genSnd
...
[[4,8,6,2,5],[10,5,1,5,4],[6,10,5,5,1],[9,9,9,7,5]]
```
